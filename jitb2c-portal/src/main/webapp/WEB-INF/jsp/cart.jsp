...
<div class="w w1 header clearfix">
	<div id="logo"><a href="/"><img clstag="clickcart|keycount|xincart|logo" src="/images/jitb2c-logo.png" title="返回金科商城首页" alt="返回金科商城首页"></a></div>
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        ...
        <div class="column t-price">金科价</div>
              ...
              <div class="cart-button">
                  ...
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          <a href="javascript:goToOverseaOrder();" class="checkout-jdInt">去金科国际结算<b></b></a>
                          <a href="javascript:goToOrder();" class="checkout-jd">去金科结算<b></b></a>
                      </span>
                  </span>
              </div>
              <div class="total fr">
